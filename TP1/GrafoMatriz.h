...
{
public:
    GrafoMatriz(int v){n=v; matriz_de_adjacencia.resize(v,vector<bool>(v,0)); degree.resize(v,0);}; //ao criarmos nosso objeto definimos uma matriz n x n  e o grau de cada vertice como 0
